...
function LoadConfig() {
	...
	Scripts.ShopBot = false; // Shopbot script. Automatically uses shopbot.nip and ignores other pickits.
		...
		Config.ShopBot.QuitOnMatch = true; // Leave game as soon as an item is shopped.

	Scripts.Test = false;
	Scripts.Sonic = true;
	Config.AutoEquip = true;

	Config.PickitFiles.push("quest.nip");

	if (!me.classic) {
		Config.PickitFiles.push("autoequip/sonic_expansion.nip");
		
		if (me.ladder > 0) {
			Config.PickitFiles.push("Expansion/Ladder/Crafted.nip");
			Config.PickitFiles.push("Expansion/Ladder/Magic.nip");
			Config.PickitFiles.push("Expansion/Ladder/Misc.nip");
			Config.PickitFiles.push("Expansion/Ladder/Rare.nip");
			Config.PickitFiles.push("Expansion/Ladder/Set.nip");
			Config.PickitFiles.push("Expansion/Ladder/Unid.nip");
			Config.PickitFiles.push("Expansion/Ladder/Unique.nip");
			Config.PickitFiles.push("Expansion/Ladder/White.nip");
		} else {
			Config.PickitFiles.push("Expansion/NonLadder/Crafted.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Magic.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Misc.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Rare.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Set.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Unid.nip");
			Config.PickitFiles.push("Expansion/NonLadder/Unique.nip");
			Config.PickitFiles.push("Expansion/NonLadder/White.nip");
		}
	...
	if (me.classic) {
		Config.PickitFiles.push("Classic/classic_rare.nip");
		Config.PickitFiles.push("Classic/classic_other.nip");
		Config.PickitFiles.push("autoequip/sonic_classic.nip");
	...
	Config.Cubing = me.hell && Pather.accessToAct(4);
	...
	*/
	...
	Config.LowGold = 1000000; // Start selling crap items if lower.
	...
	//Config.Recipes.push([Recipe.Rune, "Ort Rune"]); // Upgrade Pul to Um
	...
	Config.ScanShrines = [15, 3, 12, 10, 8, 9, 11];
