            ...
            if (!item.getFlag(0x10) && item.location === 3 && Town.ignoredItemTypes.indexOf(item.itemType) === -1) {
                ...
                switch (result.result) {
                    ...
                    case -1:
                        ...
                        /*
                        if (!Item.autoEquipCheck(item) && !Item.autoEquipCheckMerc(item) && NTIP.CheckItem(item, NTIP_CheckListNoTier, true).result != 1) {
                            result.result = 0;
                        }*/
...
/**
 *
 * POINTS BASED PICKIT STUFF BELOW - //pbp
 *
 */

// clear stash of old items
